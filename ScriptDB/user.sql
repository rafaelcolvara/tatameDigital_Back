...
-- object: public."Contratante" | type: TABLE --
-- DROP TABLE IF EXISTS public."Contratante" CASCADE;
CREATE TABLE public."Contratante" (
	id smallint NOT NULL GENERATED ALWAYS AS IDENTITY ,
	nome text NOT NULL,
	celular smallint NOT NULL,
	CONSTRAINT "Contratante_pk" PRIMARY KEY (id)
);
-- ddl-end --
ALTER TABLE public."Contratante" OWNER TO postgres;
-- ddl-end --

-- object: "Contratante_fk" | type: CONSTRAINT --
-- ALTER TABLE public."Evento" DROP CONSTRAINT IF EXISTS "Contratante_fk" CASCADE;
ALTER TABLE public."Evento" ADD CONSTRAINT "Contratante_fk" FOREIGN KEY ("id_Contratante")
REFERENCES public."Contratante" (id) MATCH FULL
ON DELETE SET NULL ON UPDATE CASCADE;
-- ddl-end --

-- object: public."TipoPessoa" | type: TABLE --
-- DROP TABLE IF EXISTS public."TipoPessoa" CASCADE;
...
-- object: "Professor_fk" | type: CONSTRAINT --
-- ALTER TABLE public."TipoPessoa" DROP CONSTRAINT IF EXISTS "Professor_fk" CASCADE;
ALTER TABLE public."TipoPessoa" ADD CONSTRAINT "Professor_fk" FOREIGN KEY ("id_Professor")
REFERENCES public."Professor" (id) MATCH FULL
ON DELETE SET NULL ON UPDATE CASCADE;
-- ddl-end --

-- object: "Usuario_fk" | type: CONSTRAINT --
-- ALTER TABLE public."TipoPessoa" DROP CONSTRAINT IF EXISTS "Usuario_fk" CASCADE;
ALTER TABLE public."TipoPessoa" ADD CONSTRAINT "Usuario_fk" FOREIGN KEY ("id_Usuario")
REFERENCES public."Usuario" (id) MATCH FULL
ON DELETE SET NULL ON UPDATE CASCADE;
-- ddl-end --

-- object: "Competidor_fk" | type: CONSTRAINT --
-- ALTER TABLE public."TipoPessoa" DROP CONSTRAINT IF EXISTS "Competidor_fk" CASCADE;
ALTER TABLE public."TipoPessoa" ADD CONSTRAINT "Competidor_fk" FOREIGN KEY ("id_Competidor")
REFERENCES public."Competidor" (id) MATCH FULL
ON DELETE SET NULL ON UPDATE CASCADE;
-- ddl-end --

-- object: "Contratante_fk" | type: CONSTRAINT --
-- ALTER TABLE public."TipoPessoa" DROP CONSTRAINT IF EXISTS "Contratante_fk" CASCADE;
ALTER TABLE public."TipoPessoa" ADD CONSTRAINT "Contratante_fk" FOREIGN KEY ("id_Contratante")
REFERENCES public."Contratante" (id) MATCH FULL
ON DELETE SET NULL ON UPDATE CASCADE;
-- ddl-end --
